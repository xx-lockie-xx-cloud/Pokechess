...
export const POKEMON_PASSIVES = {
  ...
  // ── Génération 3 (Hoenn) : passifs ──
  252: {
    35: { id:'celerite_252', name:'Célérité', desc:'+15% VIT',
      hooks:{ ON_SETUP: [{ type:'stat_boost', stat:'spd', mult:1.15 }] } },
    70: { id:'absorption_252', name:'Absorption', desc:'Draine 12% des dégâts infligés',
      hooks:{ ON_ATTACK: [{ type:'drain', rate:0.12 }] } },
  },
  253: {
    35: { id:'chlorophylle_253', name:'Chlorophylle', desc:'+20% VIT',
      hooks:{ ON_SETUP: [{ type:'stat_boost', stat:'spd', mult:1.2 }] } },
    70: { id:'seve_vive_253', name:'Sève Vive', desc:'Soigne 5% PV à chaque action',
      hooks:{ ON_ACTION: [{ type:'heal_self', rate:0.05 }] } },
  },
  254: {
    35: { id:'fulgurance_254', name:'Fulgurance', desc:'+25% VIT',
      hooks:{ ON_SETUP: [{ type:'stat_boost', stat:'spd', mult:1.25 }] } },
    70: { id:'lame_affutee_254', name:'Lame Affûtée', desc:'25% de frapper une seconde fois',
      hooks:{ ON_ATTACK: [{ type:'bonus_hit', mult:0.5, chance:0.25 }] } },
  },
  255: {
    35: { id:'fievre_255', name:'Fièvre', desc:'+15% ATK',
      hooks:{ ON_SETUP: [{ type:'stat_boost', stat:'atk', mult:1.15 }] } },
    70: { id:'corps_ardent_255', name:'Corps Ardent', desc:'20% de brûler l\'attaquant',
      hooks:{ ON_RECEIVE: [{ type:'proc_status_attacker', status:'burn', chance:0.2 }] } },
  },
  256: {
    35: { id:'cur_de_feu_256', name:'Cœur de Feu', desc:'+18% ATK',
      hooks:{ ON_SETUP: [{ type:'stat_boost', stat:'atk', mult:1.18 }] } },
    70: { id:'baston_256', name:'Baston', desc:'+5% ATK par attaque (max 30%)',
      hooks:{ ON_ATTACK: [{ type:'ramp_stat', stat:'atk', rate:0.05, max:0.3 }] } },
  },
  257: {
    35: { id:'fureur_257', name:'Fureur', desc:'+6% ATK par attaque (max 36%)',
      hooks:{ ON_ATTACK: [{ type:'ramp_stat', stat:'atk', rate:0.06, max:0.36 }] } },
    70: { id:'brasier_vengeur_257', name:'Brasier Vengeur', desc:'+30% ATK et ATK spé sous 50% PV',
      hooks:{ ON_ACTION: [{ type:'conditional_stat', stats:['atk','spa'], mult:1.3, condition:'hp_below', threshold:0.5 }] } },
  },
  258: {
    35: { id:'torrent_258', name:'Torrent', desc:'+15% ATK',
      hooks:{ ON_SETUP: [{ type:'stat_boost', stat:'atk', mult:1.15 }] } },
    70: { id:'endurance_258', name:'Endurance', desc:'+12% PV',
      hooks:{ ON_SETUP: [{ type:'stat_boost', stat:'hp', mult:1.12 }] } },
  },
  259: {
    35: { id:'tourbe_259', name:'Tourbe', desc:'+15% DEF',
      hooks:{ ON_SETUP: [{ type:'stat_boost', stat:'def', mult:1.15 }] } },
    70: { id:'absorb_eau_259', name:'Absorb-Eau', desc:'Absorbe 8% des dégâts reçus en soins',
      hooks:{ ON_RECEIVE: [{ type:'drain_receive', rate:0.08 }] } },
  },
  260: {
    35: { id:'colosse_260', name:'Colosse', desc:'+15% PV',
      hooks:{ ON_SETUP: [{ type:'stat_boost', stat:'hp', mult:1.15 }] } },
    70: { id:'torrent_majeur_260', name:'Torrent Majeur', desc:'+30% ATK sous 50% PV',
      hooks:{ ON_ACTION: [{ type:'conditional_stat', stats:['atk'], mult:1.3, condition:'hp_below', threshold:0.5 }] } },
  },
  261: {
    35: { id:'instinct_261', name:'Instinct', desc:'+12% ATK',
      hooks:{ ON_SETUP: [{ type:'stat_boost', stat:'atk', mult:1.12 }] } },
    70: { id:'meute_261', name:'Meute', desc:'+8% ATK par allié Ténèbres',
      hooks:{ ON_SETUP: [{ type:'stack_per_ally', stat:'atk', rate:0.08, allyType:'Ténèbres' }] } },
  },
  262: {
    35: { id:'intimidation_262', name:'Intimidation', desc:'-20% ATK aux ennemis',
      hooks:{ ON_SETUP: [{ type:'intimidate', stats:['atk'], mult:0.8 }] } },
    70: { id:'chef_de_meute_262', name:'Chef de Meute', desc:'+10% ATK aux alliés Ténèbres',
      hooks:{ ON_SETUP: [{ type:'aura_type_boost', allyType:'Ténèbres', mult:1.1 }] } },
  },
  263: {
    35: { id:'ramassage_263', name:'Ramassage', desc:'+15% VIT',
      hooks:{ ON_SETUP: [{ type:'stat_boost', stat:'spd', mult:1.15 }] } },
    70: { id:'fouineur_263', name:'Fouineur', desc:'10 pièces en début de combat',
      hooks:{ ON_SETUP: [{ type:'stat_boost', stat:'spd', mult:1.1 }] } },
  },
  264: {
    35: { id:'vitesse_pure_264', name:'Vitesse Pure', desc:'+25% VIT',
      hooks:{ ON_SETUP: [{ type:'stat_boost', stat:'spd', mult:1.25 }] } },
    70: { id:'assaut_eclair_264', name:'Assaut Éclair', desc:'25% de frapper deux fois',
      hooks:{ ON_ATTACK: [{ type:'bonus_hit', mult:0.6, chance:0.25 }] } },
  },
  265: {
    35: { id:'carapace_265', name:'Carapace', desc:'+12% DEF',
      hooks:{ ON_SETUP: [{ type:'stat_boost', stat:'def', mult:1.12 }] } },
    70: { id:'mue_265', name:'Mue', desc:'Soigne 4% PV à chaque action',
      hooks:{ ON_ACTION: [{ type:'heal_self', rate:0.04 }] } },
  },
  266: {
    35: { id:'cocon_266', name:'Cocon', desc:'+20% DEF',
      hooks:{ ON_SETUP: [{ type:'stat_boost', stat:'def', mult:1.2 }] } },
    70: { id:'durcissement_266', name:'Durcissement', desc:'+15% DEF et DEF spé',
      hooks:{ ON_SETUP: [{ type:'stat_boost', stat:'spd_def', mult:1.15 }] } },
  },
  267: {
    35: { id:'poudre_267', name:'Poudre', desc:'20% de poison en attaque',
      hooks:{ ON_ATTACK: [{ type:'proc_status', status:'poison', chance:0.2 }] } },
    70: { id:'essaim_aile_267', name:'Essaim Ailé', desc:'+8% ATK spé par allié Insecte',
      hooks:{ ON_SETUP: [{ type:'stack_per_ally', stat:'spa', rate:0.08, allyType:'Insecte' }] } },
  },
  268: {
    35: { id:'soie_268', name:'Soie', desc:'+20% DEF spé',
      hooks:{ ON_SETUP: [{ type:'stat_boost', stat:'spd_def', mult:1.2 }] } },
    70: { id:'trame_268', name:'Trame', desc:'Absorbe 8% des dégâts reçus en soins',
      hooks:{ ON_RECEIVE: [{ type:'drain_receive', rate:0.08 }] } },
  },
  269: {
    35: { id:'pulverulence_269', name:'Pulvérulence', desc:'30% de poison en attaque',
      hooks:{ ON_ATTACK: [{ type:'proc_status', status:'poison', chance:0.3 }] } },
    70: { id:'spores_toxiques_269', name:'Spores Toxiques', desc:'Inflige 8% PV aux ennemis / 8 actions',
      hooks:{ ON_PERIODIC: [{ type:'dot_enemies', rate:0.08 }] } },
  },
  270: {
    35: { id:'moiteur_270', name:'Moiteur', desc:'+12% ATK spé',
      hooks:{ ON_SETUP: [{ type:'stat_boost', stat:'spa', mult:1.12 }] } },
    70: { id:'absorb_eau_270', name:'Absorb-Eau', desc:'Immunisé au type Eau',
      hooks:{ ON_SETUP: [{ type:'type_absorb', damageType:'Eau' }] } },
  },
  271: {
    35: { id:'hydratation_271', name:'Hydratation', desc:'Soigne 5% PV à chaque action',
      hooks:{ ON_ACTION: [{ type:'heal_self', rate:0.05 }] } },
    70: { id:'danseur_271', name:'Danseur', desc:'+15% VIT',
      hooks:{ ON_SETUP: [{ type:'stat_boost', stat:'spd', mult:1.15 }] } },
  },
  272: {
    35: { id:'faiseur_de_pluie_272', name:'Faiseur de Pluie', desc:'Déclenche la Pluie au début du combat',
      hooks:{ ON_SETUP: [{ type:'weather_setter', weather:'rain' }] } },
    70: { id:'festin_272', name:'Festin', desc:'Soigne 5% PV à tous les alliés / 8 actions',
      hooks:{ ON_PERIODIC: [{ type:'heal_all', rate:0.05 }] } },
  },
  273: {
    35: { id:'racines_273', name:'Racines', desc:'Soigne 4% PV à chaque action',
      hooks:{ ON_ACTION: [{ type:'heal_self', rate:0.04 }] } },
    70: { id:'absorption_273', name:'Absorption', desc:'Draine 12% des dégâts infligés',
      hooks:{ ON_ATTACK: [{ type:'drain', rate:0.12 }] } },
  },
  274: {
    35: { id:'ruse_274', name:'Ruse', desc:'+15% ATK',
      hooks:{ ON_SETUP: [{ type:'stat_boost', stat:'atk', mult:1.15 }] } },
    70: { id:'larcin_274', name:'Larcin', desc:'Draine 15% des dégâts infligés',
      hooks:{ ON_ATTACK: [{ type:'drain', rate:0.15 }] } },
  },
  275: {
    35: { id:'ombre_portee_275', name:'Ombre Portée', desc:'-20% ATK spé aux ennemis',
      hooks:{ ON_SETUP: [{ type:'intimidate', stats:['spa'], mult:0.8 }] } },
    70: { id:'nuit_noire_275', name:'Nuit Noire', desc:'Déclenche la Nuit Noire au début du combat',
      hooks:{ ON_SETUP: [{ type:'weather_setter', weather:'darkness' }] } },
  },
  276: {
    35: { id:'agilite_276', name:'Agilité', desc:'+15% VIT',
      hooks:{ ON_SETUP: [{ type:'stat_boost', stat:'spd', mult:1.15 }] } },
    70: { id:'pique_276', name:'Piqué', desc:'+12% ATK',
      hooks:{ ON_SETUP: [{ type:'stat_boost', stat:'atk', mult:1.12 }] } },
  },
  277: {
    35: { id:'vitesse_277', name:'Vitesse', desc:'+25% VIT',
      hooks:{ ON_SETUP: [{ type:'stat_boost', stat:'spd', mult:1.25 }] } },
    70: { id:'endurance_ailee_277', name:'Endurance Ailée', desc:'+30% ATK sous 50% PV',
      hooks:{ ON_ACTION: [{ type:'conditional_stat', stats:['atk'], mult:1.3, condition:'hp_below', threshold:0.5 }] } },
  },
  278: {
    35: { id:'plumage_278', name:'Plumage', desc:'+12% DEF spé',
      hooks:{ ON_SETUP: [{ type:'stat_boost', stat:'spd_def', mult:1.12 }] } },
    70: { id:'sillage_278', name:'Sillage', desc:'+15% VIT',
      hooks:{ ON_SETUP: [{ type:'stat_boost', stat:'spd', mult:1.15 }] } },
  },
  279: {
    35: { id:'grand_gosier_279', name:'Grand Gosier', desc:'+15% PV',
      hooks:{ ON_SETUP: [{ type:'stat_boost', stat:'hp', mult:1.15 }] } },
    70: { id:'tempete_279', name:'Tempête', desc:'Déclenche la Pluie au début du combat',
      hooks:{ ON_SETUP: [{ type:'weather_setter', weather:'rain' }] } },
  },
  280: {
    35: { id:'synchronise_280', name:'Synchronise', desc:'20% de confusion en attaque',
      hooks:{ ON_ATTACK: [{ type:'proc_status', status:'confuse', chance:0.2 }] } },
    70: { id:'telepathie_280', name:'Télépathie', desc:'+15% ATK spé',
      hooks:{ ON_SETUP: [{ type:'stat_boost', stat:'spa', mult:1.15 }] } },
  },
  281: {
    35: { id:'trace_281', name:'Trace', desc:'+18% ATK spé',
      hooks:{ ON_SETUP: [{ type:'stat_boost', stat:'spa', mult:1.18 }] } },
    70: { id:'grace_281', name:'Grâce', desc:'+15% VIT',
      hooks:{ ON_SETUP: [{ type:'stat_boost', stat:'spd', mult:1.15 }] } },
  },
  282: {
    35: { id:'aura_feerique_282', name:'Aura Féerique', desc:'+12% toutes stats aux alliés',
      hooks:{ ON_SETUP: [{ type:'aura_all_boost', mult:1.12 }] } },
    70: { id:'garde_mystique_282', name:'Garde Mystique', desc:'Protège un allié de la mort une fois',
      hooks:{ ON_SETUP: [{ type:'no_ally_ko' }] } },
  },
  283: {
    35: { id:'patineur_283', name:'Patineur', desc:'+18% VIT',
      hooks:{ ON_SETUP: [{ type:'stat_boost', stat:'spd', mult:1.18 }] } },
    70: { id:'toile_283', name:'Toile', desc:'-15% VIT aux ennemis touchés',
      hooks:{ ON_ATTACK: [{ type:'debuff_target', stat:'spd', mult:0.85 }] } },
  },
  284: {
    35: { id:'il_compose_284', name:'Œil Composé', desc:'+20% ATK spé',
      hooks:{ ON_SETUP: [{ type:'stat_boost', stat:'spa', mult:1.2 }] } },
    70: { id:'piege_soyeux_284', name:'Piège Soyeux', desc:'-20% VIT aux ennemis',
      hooks:{ ON_SETUP: [{ type:'intimidate', stats:['spd'], mult:0.8 }] } },
  },
  285: {
    35: { id:'spores_285', name:'Spores', desc:'25% de sommeil en attaque',
      hooks:{ ON_ATTACK: [{ type:'proc_status', status:'sleep', chance:0.25 }] } },
    70: { id:'champignon_285', name:'Champignon', desc:'Draine 12% des dégâts infligés',
      hooks:{ ON_ATTACK: [{ type:'drain', rate:0.12 }] } },
  },
  286: {
    35: { id:'techniparade_286', name:'Techniparade', desc:'+20% ATK',
      hooks:{ ON_SETUP: [{ type:'stat_boost', stat:'atk', mult:1.2 }] } },
    70: { id:'reve_devorant_286', name:'Rêve Dévorant', desc:'Inflige 10% PV aux ennemis endormis / 8 actions',
      hooks:{ ON_PERIODIC: [{ type:'dot_sleeping_enemies', rate:0.1 }] } },
  },
  287: {
    35: { id:'cool_287', name:'Cool', desc:'Soigne 5% PV à chaque action',
      hooks:{ ON_ACTION: [{ type:'heal_self', rate:0.05 }] } },
    70: { id:'sieste_287', name:'Sieste', desc:'Soigne 25% PV / 8 actions',
      hooks:{ ON_PERIODIC: [{ type:'heal_self_periodic', rate:0.25 }] } },
  },
  288: {
    35: { id:'insomnia_288', name:'Insomnia', desc:'Immunisé au sommeil',
      hooks:{ ON_SETUP: [{ type:'status_immunity', statuses:['sleep'] }] } },
    70: { id:'hyperactif_288', name:'Hyperactif', desc:'+22% VIT',
      hooks:{ ON_SETUP: [{ type:'stat_boost', stat:'spd', mult:1.22 }] } },
  },
  289: {
    35: { id:'colosse_289', name:'Colosse', desc:'+20% PV et pardon',
      hooks:{ ON_SETUP: [{ type:'stat_boost', stat:'hp', mult:1.2 }] } },
    70: { id:'force_brute_289', name:'Force Brute', desc:'+35% ATK',
      hooks:{ ON_SETUP: [{ type:'stat_boost', stat:'atk', mult:1.35 }] } },
  },
  290: {
    35: { id:'fouisseur_290', name:'Fouisseur', desc:'+15% DEF',
      hooks:{ ON_SETUP: [{ type:'stat_boost', stat:'def', mult:1.15 }] } },
    70: { id:'mue_proche_290', name:'Mue Proche', desc:'+15% VIT',
      hooks:{ ON_SETUP: [{ type:'stat_boost', stat:'spd', mult:1.15 }] } },
  },
  291: {
    35: { id:'turbo_291', name:'Turbo', desc:'+35% VIT',
      hooks:{ ON_SETUP: [{ type:'stat_boost', stat:'spd', mult:1.35 }] } },
    70: { id:'essaim_veloce_291', name:'Essaim Véloce', desc:'+8% VIT par allié Insecte',
      hooks:{ ON_SETUP: [{ type:'stack_per_ally', stat:'spd', rate:0.08, allyType:'Insecte' }] } },
  },
  292: {
    35: { id:'garde_mystik_292', name:'Garde Mystik', desc:'50% d\'esquive',
      hooks:{ ON_SETUP: [{ type:'evasion', chance:0.5 }] } },
    70: { id:'corps_vide_292', name:'Corps Vide', desc:'Immunisé au type Normal',
      hooks:{ ON_SETUP: [{ type:'type_immunity', damageType:'Normal' }] } },
  },
  293: {
    35: { id:'insonorisant_293', name:'Insonorisant', desc:'Immunisé à la confusion',
      hooks:{ ON_SETUP: [{ type:'status_immunity', statuses:['confuse'] }] } },
    70: { id:'vibration_293', name:'Vibration', desc:'+12% ATK spé',
      hooks:{ ON_SETUP: [{ type:'stat_boost', stat:'spa', mult:1.12 }] } },
  },
  294: {
    35: { id:'grondement_294', name:'Grondement', desc:'+15% ATK spé',
      hooks:{ ON_SETUP: [{ type:'stat_boost', stat:'spa', mult:1.15 }] } },
    70: { id:'fracas_294', name:'Fracas', desc:'-15% DEF aux ennemis touchés',
      hooks:{ ON_ATTACK: [{ type:'debuff_target', stat:'def', mult:0.85 }] } },
  },
  295: {
    35: { id:'boucan_295', name:'Boucan', desc:'-20% DEF spé aux ennemis',
      hooks:{ ON_SETUP: [{ type:'intimidate', stats:['spd_def'], mult:0.8 }] } },
    70: { id:'vacarme_295', name:'Vacarme', desc:'Inflige 8% PV aux ennemis / 8 actions',
      hooks:{ ON_PERIODIC: [{ type:'dot_enemies', rate:0.08 }] } },
  },
  296: {
    35: { id:'cran_296', name:'Cran', desc:'+15% PV',
      hooks:{ ON_SETUP: [{ type:'stat_boost', stat:'hp', mult:1.15 }] } },
    70: { id:'endurance_296', name:'Endurance', desc:'Absorbe 8% des dégâts reçus en soins',
      hooks:{ ON_RECEIVE: [{ type:'drain_receive', rate:0.08 }] } },
  },
  297: {
    35: { id:'epaisseur_297', name:'Épaisseur', desc:'-15% dégâts subis par les alliés',
      hooks:{ ON_SETUP: [{ type:'aura_dmg_reduction', mult:0.85 }] } },
    70: { id:'tenacite_297', name:'Ténacité', desc:'+30% ATK sous 50% PV',
      hooks:{ ON_ACTION: [{ type:'conditional_stat', stats:['atk'], mult:1.3, condition:'hp_below', threshold:0.5 }] } },
  },
  298: {
    35: { id:'ballon_298', name:'Ballon', desc:'+15% PV',
      hooks:{ ON_SETUP: [{ type:'stat_boost', stat:'hp', mult:1.15 }] } },
    70: { id:'douceur_298', name:'Douceur', desc:'Soigne 5% PV à l\'allié le plus blessé / 8 actions',
      hooks:{ ON_PERIODIC: [{ type:'heal_weakest_ally', rate:0.05 }] } },
  },
  299: {
    35: { id:'solide_roc_299', name:'Solide Roc', desc:'-15% dégâts subis par les alliés',
      hooks:{ ON_SETUP: [{ type:'aura_dmg_reduction', mult:0.85 }] } },
    70: { id:'muraille_299', name:'Muraille', desc:'+25% DEF',
      hooks:{ ON_SETUP: [{ type:'stat_boost', stat:'def', mult:1.25 }] } },
  },
  300: {
    35: { id:'charmeur_300', name:'Charmeur', desc:'-20% ATK aux ennemis',
      hooks:{ ON_SETUP: [{ type:'intimidate', stats:['atk'], mult:0.8 }] } },
    70: { id:'calin_300', name:'Câlin', desc:'+12% VIT',
      hooks:{ ON_SETUP: [{ type:'stat_boost', stat:'spd', mult:1.12 }] } },
  },
  301: {
    35: { id:'attention_301', name:'Attention', desc:'+18% VIT',
      hooks:{ ON_SETUP: [{ type:'stat_boost', stat:'spd', mult:1.18 }] } },
    70: { id:'ronronnement_301', name:'Ronronnement', desc:'Soigne 5% PV à tous les alliés / 8 actions',
      hooks:{ ON_PERIODIC: [{ type:'heal_all', rate:0.05 }] } },
  },
  302: {
    35: { id:'clairvoyance_302', name:'Clairvoyance', desc:'25% d\'esquive',
      hooks:{ ON_SETUP: [{ type:'evasion', chance:0.25 }] } },
    70: { id:'vol_de_vie_302', name:'Vol de Vie', desc:'Draine 20% des dégâts infligés',
      hooks:{ ON_ATTACK: [{ type:'drain', rate:0.2 }] } },
  },
  303: {
    35: { id:'intimidation_303', name:'Intimidation', desc:'-20% ATK aux ennemis',
      hooks:{ ON_SETUP: [{ type:'intimidate', stats:['atk'], mult:0.8 }] } },
    70: { id:'piege_feerique_303', name:'Piège Féerique', desc:'20% de paralysie sur l\'attaquant',
      hooks:{ ON_RECEIVE: [{ type:'proc_status_attacker', status:'paralyze', chance:0.2 }] } },
  },
  304: {
    35: { id:'robuste_304', name:'Robuste', desc:'+18% DEF',
      hooks:{ ON_SETUP: [{ type:'stat_boost', stat:'def', mult:1.18 }] } },
    70: { id:'blindage_304', name:'Blindage', desc:'-15% dégâts subis par les alliés',
      hooks:{ ON_SETUP: [{ type:'aura_dmg_reduction', mult:0.85 }] } },
  },
  305: {
    35: { id:'carapace_d_acier_305', name:'Carapace d\'Acier', desc:'+22% DEF',
      hooks:{ ON_SETUP: [{ type:'stat_boost', stat:'def', mult:1.22 }] } },
    70: { id:'rempart_305', name:'Rempart', desc:'Bouclier au début du combat',
      hooks:{ ON_SETUP: [{ type:'shield' }] } },
  },
  306: {
    35: { id:'forteresse_306', name:'Forteresse', desc:'+25% DEF et bouclier',
      hooks:{ ON_SETUP: [{ type:'shield' }] } },
    70: { id:'colere_de_fer_306', name:'Colère de Fer', desc:'+6% ATK à chaque coup reçu (max 36%)',
      hooks:{ ON_RECEIVE: [{ type:'rage', stat:'atk', rate:0.06, max:0.36 }] } },
  },
  307: {
    35: { id:'meditation_307', name:'Méditation', desc:'+15% ATK',
      hooks:{ ON_SETUP: [{ type:'stat_boost', stat:'atk', mult:1.15 }] } },
    70: { id:'serenite_307', name:'Sérénité', desc:'Soigne 5% PV à chaque action',
      hooks:{ ON_ACTION: [{ type:'heal_self', rate:0.05 }] } },
  },
  308: {
    35: { id:'force_pure_308', name:'Force Pure', desc:'+30% ATK',
      hooks:{ ON_SETUP: [{ type:'stat_boost', stat:'atk', mult:1.3 }] } },
    70: { id:'transe_308', name:'Transe', desc:'+5% ATK par attaque (max 40%)',
      hooks:{ ON_ATTACK: [{ type:'ramp_stat', stat:'atk', rate:0.05, max:0.4 }] } },
  },
  309: {
    35: { id:'statik_309', name:'Statik', desc:'20% de paralysie sur l\'attaquant',
      hooks:{ ON_RECEIVE: [{ type:'proc_status_attacker', status:'paralyze', chance:0.2 }] } },
    70: { id:'vive_volt_309', name:'Vive-Volt', desc:'+18% VIT',
      hooks:{ ON_SETUP: [{ type:'stat_boost', stat:'spd', mult:1.18 }] } },
  },
  310: {
    35: { id:'paratonnerre_310', name:'Paratonnerre', desc:'Immunisé au type Électrik',
      hooks:{ ON_SETUP: [{ type:'type_absorb', damageType:'Électrik' }] } },
    70: { id:'survolt_310', name:'Survolt', desc:'+30% VIT',
      hooks:{ ON_SETUP: [{ type:'stat_boost', stat:'spd', mult:1.3 }] } },
  },
  311: {
    35: { id:'plus_311', name:'Plus', desc:'+10% ATK spé aux alliés Électrik',
      hooks:{ ON_SETUP: [{ type:'aura_type_boost', allyType:'Électrik', mult:1.1 }] } },
    70: { id:'encouragement_311', name:'Encouragement', desc:'Soigne 5% PV à l\'allié le plus blessé / 8 actions',
      hooks:{ ON_PERIODIC: [{ type:'heal_weakest_ally', rate:0.05 }] } },
  },
  312: {
    35: { id:'minus_312', name:'Minus', desc:'+10% VIT aux alliés Électrik',
      hooks:{ ON_SETUP: [{ type:'aura_type_boost', allyType:'Électrik', mult:1.1 }] } },
    70: { id:'decharge_312', name:'Décharge', desc:'Inflige 8% PV aux ennemis / 8 actions',
      hooks:{ ON_PERIODIC: [{ type:'dot_enemies', rate:0.08 }] } },
  },
  313: {
    35: { id:'illumination_313', name:'Illumination', desc:'+18% ATK',
      hooks:{ ON_SETUP: [{ type:'stat_boost', stat:'atk', mult:1.18 }] } },
    70: { id:'escorte_313', name:'Escorte', desc:'+8% ATK par allié Insecte',
      hooks:{ ON_SETUP: [{ type:'stack_per_ally', stat:'atk', rate:0.08, allyType:'Insecte' }] } },
  },
  314: {
    35: { id:'lueur_314', name:'Lueur', desc:'+18% ATK spé',
      hooks:{ ON_SETUP: [{ type:'stat_boost', stat:'spa', mult:1.18 }] } },
    70: { id:'signal_lumineux_314', name:'Signal Lumineux', desc:'-20% ATK aux ennemis',
      hooks:{ ON_SETUP: [{ type:'intimidate', stats:['atk'], mult:0.8 }] } },
  },
  315: {
    35: { id:'point_poison_315', name:'Point Poison', desc:'25% de poison sur l\'attaquant',
      hooks:{ ON_RECEIVE: [{ type:'proc_status_attacker', status:'poison', chance:0.25 }] } },
    70: { id:'parfum_315', name:'Parfum', desc:'Inflige 8% PV aux ennemis / 8 actions',
      hooks:{ ON_PERIODIC: [{ type:'dot_enemies', rate:0.08 }] } },
  },
  316: {
    35: { id:'estomac_316', name:'Estomac', desc:'+15% PV',
      hooks:{ ON_SETUP: [{ type:'stat_boost', stat:'hp', mult:1.15 }] } },
    70: { id:'suc_digestif_316', name:'Suc Digestif', desc:'Draine 15% des dégâts infligés',
      hooks:{ ON_ATTACK: [{ type:'drain', rate:0.15 }] } },
  },
  317: {
    35: { id:'glouton_317', name:'Glouton', desc:'Soigne 20% PV sous 30% PV',
      hooks:{ ON_ACTION: [{ type:'emergency_heal', rate:0.2, threshold:0.3 }] } },
    70: { id:'acide_gastrique_317', name:'Acide Gastrique', desc:'Draine 20% des dégâts infligés',
      hooks:{ ON_ATTACK: [{ type:'drain', rate:0.2 }] } },
  },
  318: {
    35: { id:'brutalite_318', name:'Brutalité', desc:'+18% ATK',
      hooks:{ ON_SETUP: [{ type:'stat_boost', stat:'atk', mult:1.18 }] } },
    70: { id:'frenesie_318', name:'Frénésie', desc:'+6% ATK à chaque coup reçu (max 36%)',
      hooks:{ ON_RECEIVE: [{ type:'rage', stat:'atk', rate:0.06, max:0.36 }] } },
  },
  319: {
    35: { id:'predateur_319', name:'Prédateur', desc:'+28% ATK',
      hooks:{ ON_SETUP: [{ type:'stat_boost', stat:'atk', mult:1.28 }] } },
    70: { id:'sang_froid_319', name:'Sang Froid', desc:'+35% ATK sous 50% PV',
      hooks:{ ON_ACTION: [{ type:'conditional_stat', stats:['atk'], mult:1.35, condition:'hp_below', threshold:0.5 }] } },
  },
  320: {
    35: { id:'reserve_d_eau_320', name:'Réserve d\'Eau', desc:'+20% PV',
      hooks:{ ON_SETUP: [{ type:'stat_boost', stat:'hp', mult:1.2 }] } },
    70: { id:'ricochet_320', name:'Ricochet', desc:'Absorbe 8% des dégâts reçus en soins',
      hooks:{ ON_RECEIVE: [{ type:'drain_receive', rate:0.08 }] } },
  },
  321: {
    35: { id:'immensite_321', name:'Immensité', desc:'+30% PV',
      hooks:{ ON_SETUP: [{ type:'stat_boost', stat:'hp', mult:1.3 }] } },
    70: { id:'deluge_321', name:'Déluge', desc:'Déclenche la Pluie au début du combat',
      hooks:{ ON_SETUP: [{ type:'weather_setter', weather:'rain' }] } },
  },
  322: {
    35: { id:'toison_322', name:'Toison', desc:'+15% DEF spé',
      hooks:{ ON_SETUP: [{ type:'stat_boost', stat:'spd_def', mult:1.15 }] } },
    70: { id:'magma_322', name:'Magma', desc:'20% de brûlure en attaque',
      hooks:{ ON_ATTACK: [{ type:'proc_status', status:'burn', chance:0.2 }] } },
  },
  323: {
    35: { id:'corps_ardent_323', name:'Corps Ardent', desc:'25% de brûlure sur l\'attaquant',
      hooks:{ ON_RECEIVE: [{ type:'proc_status_attacker', status:'burn', chance:0.25 }] } },
    70: { id:'volcan_323', name:'Volcan', desc:'Déclenche le Zénith au début du combat',
      hooks:{ ON_SETUP: [{ type:'weather_setter', weather:'sun' }] } },
  },
  324: {
    35: { id:'carapace_ardente_324', name:'Carapace Ardente', desc:'+22% DEF',
      hooks:{ ON_SETUP: [{ type:'stat_boost', stat:'def', mult:1.22 }] } },
    70: { id:'fournaise_324', name:'Fournaise', desc:'Immunisé au type Feu',
      hooks:{ ON_SETUP: [{ type:'type_absorb', damageType:'Feu' }] } },
  },
  325: {
    35: { id:'rebond_325', name:'Rebond', desc:'+15% VIT',
      hooks:{ ON_SETUP: [{ type:'stat_boost', stat:'spd', mult:1.15 }] } },
    70: { id:'perle_mentale_325', name:'Perle Mentale', desc:'+15% ATK spé',
      hooks:{ ON_SETUP: [{ type:'stat_boost', stat:'spa', mult:1.15 }] } },
  },
  326: {
    35: { id:'gourmandise_326', name:'Gourmandise', desc:'Soigne 20% PV sous 30% PV',
      hooks:{ ON_ACTION: [{ type:'emergency_heal', rate:0.2, threshold:0.3 }] } },
    70: { id:'esprit_vif_326', name:'Esprit Vif', desc:'+28% ATK spé',
      hooks:{ ON_SETUP: [{ type:'stat_boost', stat:'spa', mult:1.28 }] } },
  },
  327: {
    35: { id:'tempo_perso_327', name:'Tempo Perso', desc:'Immunisé à la confusion',
      hooks:{ ON_SETUP: [{ type:'status_immunity', statuses:['confuse'] }] } },
    70: { id:'titubant_327', name:'Titubant', desc:'30% d\'esquive',
      hooks:{ ON_SETUP: [{ type:'evasion', chance:0.3 }] } },
  },
  328: {
    35: { id:'fouisseur_328', name:'Fouisseur', desc:'+15% ATK',
      hooks:{ ON_SETUP: [{ type:'stat_boost', stat:'atk', mult:1.15 }] } },
    70: { id:'sables_328', name:'Sables', desc:'-15% VIT aux ennemis touchés',
      hooks:{ ON_ATTACK: [{ type:'debuff_target', stat:'spd', mult:0.85 }] } },
  },
  329: {
    35: { id:'levitation_329', name:'Lévitation', desc:'Immunisé au type Sol',
      hooks:{ ON_SETUP: [{ type:'type_immunity', damageType:'Sol' }] } },
    70: { id:'vrombissement_329', name:'Vrombissement', desc:'+18% VIT',
      hooks:{ ON_SETUP: [{ type:'stat_boost', stat:'spd', mult:1.18 }] } },
  },
  330: {
    35: { id:'levitation_330', name:'Lévitation', desc:'Immunisé au type Sol',
      hooks:{ ON_SETUP: [{ type:'type_immunity', damageType:'Sol' }] } },
    70: { id:'tempete_de_sable_330', name:'Tempête de Sable', desc:'Déclenche la Tempête de sable au début du combat',
      hooks:{ ON_SETUP: [{ type:'weather_setter', weather:'sandstorm' }] } },
  },
  331: {
    35: { id:'epines_331', name:'Épines', desc:'20% de poison sur l\'attaquant',
      hooks:{ ON_RECEIVE: [{ type:'proc_status_attacker', status:'poison', chance:0.2 }] } },
    70: { id:'aridite_331', name:'Aridité', desc:'Draine 12% des dégâts infligés',
      hooks:{ ON_ATTACK: [{ type:'drain', rate:0.12 }] } },
  },
  332: {
    35: { id:'epouvantail_332', name:'Épouvantail', desc:'-20% ATK aux ennemis',
      hooks:{ ON_SETUP: [{ type:'intimidate', stats:['atk'], mult:0.8 }] } },
    70: { id:'sable_mouvant_332', name:'Sable Mouvant', desc:'+25% ATK sous Tempête de sable',
      hooks:{ ON_SETUP: [{ type:'weather_boost', mult:1.25 }] } },
  },
  333: {
    35: { id:'voix_douce_333', name:'Voix Douce', desc:'+15% DEF spé',
      hooks:{ ON_SETUP: [{ type:'stat_boost', stat:'spd_def', mult:1.15 }] } },
    70: { id:'plumage_333', name:'Plumage', desc:'Soigne 5% PV à chaque action',
      hooks:{ ON_ACTION: [{ type:'heal_self', rate:0.05 }] } },
  },
  334: {
    35: { id:'cocon_de_laine_334', name:'Cocon de Laine', desc:'+20% DEF spé',
      hooks:{ ON_SETUP: [{ type:'stat_boost', stat:'spd_def', mult:1.2 }] } },
    70: { id:'berceuse_celeste_334', name:'Berceuse Céleste', desc:'Soigne 5% PV à tous les alliés / 8 actions',
      hooks:{ ON_PERIODIC: [{ type:'heal_all', rate:0.05 }] } },
  },
  335: {
    35: { id:'immunite_335', name:'Immunité', desc:'Immunisé au poison',
      hooks:{ ON_SETUP: [{ type:'status_immunity', statuses:['poison'] }] } },
    70: { id:'laceration_335', name:'Lacération', desc:'+30% ATK',
      hooks:{ ON_SETUP: [{ type:'stat_boost', stat:'atk', mult:1.3 }] } },
  },
  336: {
    35: { id:'mue_336', name:'Mue', desc:'30% de poison en attaque',
      hooks:{ ON_ATTACK: [{ type:'proc_status', status:'poison', chance:0.3 }] } },
    70: { id:'venin_mortel_336', name:'Venin Mortel', desc:'Inflige 10% PV aux ennemis / 8 actions',
      hooks:{ ON_PERIODIC: [{ type:'dot_enemies', rate:0.1 }] } },
  },
  337: {
    35: { id:'levitation_337', name:'Lévitation', desc:'Immunisé au type Sol',
      hooks:{ ON_SETUP: [{ type:'type_immunity', damageType:'Sol' }] } },
    70: { id:'clair_de_lune_337', name:'Clair de Lune', desc:'Déclenche la Nuit Noire au début du combat',
      hooks:{ ON_SETUP: [{ type:'weather_setter', weather:'darkness' }] } },
  },
  338: {
    35: { id:'levitation_338', name:'Lévitation', desc:'Immunisé au type Sol',
      hooks:{ ON_SETUP: [{ type:'type_immunity', damageType:'Sol' }] } },
    70: { id:'astre_solaire_338', name:'Astre Solaire', desc:'Déclenche le Zénith au début du combat',
      hooks:{ ON_SETUP: [{ type:'weather_setter', weather:'sun' }] } },
  },
  339: {
    35: { id:'anticipation_339', name:'Anticipation', desc:'+15% PV',
      hooks:{ ON_SETUP: [{ type:'stat_boost', stat:'hp', mult:1.15 }] } },
    70: { id:'glissant_339', name:'Glissant', desc:'20% d\'esquive',
      hooks:{ ON_SETUP: [{ type:'evasion', chance:0.2 }] } },
  },
  340: {
    35: { id:'peau_seche_340', name:'Peau Sèche', desc:'Immunisé au type Eau',
      hooks:{ ON_SETUP: [{ type:'type_absorb', damageType:'Eau' }] } },
    70: { id:'seisme_340', name:'Séisme', desc:'+25% ATK',
      hooks:{ ON_SETUP: [{ type:'stat_boost', stat:'atk', mult:1.25 }] } },
  },
  341: {
    35: { id:'carapace_341', name:'Carapace', desc:'+18% DEF',
      hooks:{ ON_SETUP: [{ type:'stat_boost', stat:'def', mult:1.18 }] } },
    70: { id:'pince_dure_341', name:'Pince Dure', desc:'-15% DEF aux ennemis touchés',
      hooks:{ ON_ATTACK: [{ type:'debuff_target', stat:'def', mult:0.85 }] } },
  },
  342: {
    35: { id:'hyper_cutter_342', name:'Hyper Cutter', desc:'+25% ATK',
      hooks:{ ON_SETUP: [{ type:'stat_boost', stat:'atk', mult:1.25 }] } },
    70: { id:'broyeur_342', name:'Broyeur', desc:'25% de frapper une seconde fois',
      hooks:{ ON_ATTACK: [{ type:'bonus_hit', mult:0.55, chance:0.25 }] } },
  },
  343: {
    35: { id:'levitation_343', name:'Lévitation', desc:'Immunisé au type Sol',
      hooks:{ ON_SETUP: [{ type:'type_immunity', damageType:'Sol' }] } },
    70: { id:'amulette_343', name:'Amulette', desc:'+15% DEF spé',
      hooks:{ ON_SETUP: [{ type:'stat_boost', stat:'spd_def', mult:1.15 }] } },
  },
  344: {
    35: { id:'levitation_344', name:'Lévitation', desc:'Immunisé au type Sol',
      hooks:{ ON_SETUP: [{ type:'type_immunity', damageType:'Sol' }] } },
    70: { id:'malediction_antique_344', name:'Malédiction Antique', desc:'Inflige 10% PV aux ennemis / 8 actions',
      hooks:{ ON_PERIODIC: [{ type:'dot_enemies', rate:0.1 }] } },
  },
  345: {
    35: { id:'succion_345', name:'Succion', desc:'Draine 15% des dégâts infligés',
      hooks:{ ON_ATTACK: [{ type:'drain', rate:0.15 }] } },
    70: { id:'enracinement_345', name:'Enracinement', desc:'Soigne 5% PV à chaque action',
      hooks:{ ON_ACTION: [{ type:'heal_self', rate:0.05 }] } },
  },
  346: {
    35: { id:'tentacules_346', name:'Tentacules', desc:'+22% ATK',
      hooks:{ ON_SETUP: [{ type:'stat_boost', stat:'atk', mult:1.22 }] } },
    70: { id:'regeneration_346', name:'Régénération', desc:'Soigne 25% PV / 8 actions',
      hooks:{ ON_PERIODIC: [{ type:'heal_self_periodic', rate:0.25 }] } },
  },
  347: {
    35: { id:'carapace_fossile_347', name:'Carapace Fossile', desc:'+15% DEF',
      hooks:{ ON_SETUP: [{ type:'stat_boost', stat:'def', mult:1.15 }] } },
    70: { id:'pinces_347', name:'Pinces', desc:'+15% ATK',
      hooks:{ ON_SETUP: [{ type:'stat_boost', stat:'atk', mult:1.15 }] } },
  },
  348: {
    35: { id:'armure_antique_348', name:'Armure Antique', desc:'+22% DEF',
      hooks:{ ON_SETUP: [{ type:'stat_boost', stat:'def', mult:1.22 }] } },
    70: { id:'predateur_antique_348', name:'Prédateur Antique', desc:'+30% ATK',
      hooks:{ ON_SETUP: [{ type:'stat_boost', stat:'atk', mult:1.3 }] } },
  },
  349: {
    35: { id:'fragile_349', name:'Fragile', desc:'+10% VIT',
      hooks:{ ON_SETUP: [{ type:'stat_boost', stat:'spd', mult:1.1 }] } },
    70: { id:'espoir_349', name:'Espoir', desc:'Soigne 5% PV à chaque action',
      hooks:{ ON_ACTION: [{ type:'heal_self', rate:0.05 }] } },
  },
  350: {
    35: { id:'ecaille_speciale_350', name:'Écaille Spéciale', desc:'+25% DEF spé',
      hooks:{ ON_SETUP: [{ type:'stat_boost', stat:'spd_def', mult:1.25 }] } },
    70: { id:'beaute_350', name:'Beauté', desc:'+12% toutes stats aux alliés',
      hooks:{ ON_SETUP: [{ type:'aura_all_boost', mult:1.12 }] } },
  },
  351: {
    35: { id:'meteo_351', name:'Météo', desc:'+25% stats sous météo active',
      hooks:{ ON_SETUP: [{ type:'weather_boost', mult:1.25 }] } },
    70: { id:'transition_351', name:'Transition', desc:'+20% de la meilleure stat',
      hooks:{ ON_SETUP: [{ type:'boost_highest_stat', mult:1.2 }] } },
  },
  352: {
    35: { id:'decalque_352', name:'Décalque', desc:'+20% de la meilleure stat',
      hooks:{ ON_SETUP: [{ type:'boost_highest_stat', mult:1.2 }] } },
    70: { id:'camouflage_352', name:'Camouflage', desc:'30% d\'esquive',
      hooks:{ ON_SETUP: [{ type:'evasion', chance:0.3 }] } },
  },
  353: {
    35: { id:'insomnia_353', name:'Insomnia', desc:'Immunisé au sommeil',
      hooks:{ ON_SETUP: [{ type:'status_immunity', statuses:['sleep'] }] } },
    70: { id:'frayeur_353', name:'Frayeur', desc:'20% de confusion en attaque',
      hooks:{ ON_ATTACK: [{ type:'proc_status', status:'confuse', chance:0.2 }] } },
  },
  354: {
    35: { id:'poupee_maudite_354', name:'Poupée Maudite', desc:'Explose pour 25% PV max à la mort',
      hooks:{ ON_DEATH: [{ type:'aoe_damage', rate:0.25 }] } },
    70: { id:'malediction_354', name:'Malédiction', desc:'Inflige 10% PV aux ennemis / 8 actions',
      hooks:{ ON_PERIODIC: [{ type:'dot_enemies', rate:0.1 }] } },
  },
  355: {
    35: { id:'levitation_355', name:'Lévitation', desc:'Immunisé au type Sol',
      hooks:{ ON_SETUP: [{ type:'type_immunity', damageType:'Sol' }] } },
    70: { id:'regard_vide_355', name:'Regard Vide', desc:'-15% VIT aux ennemis touchés',
      hooks:{ ON_ATTACK: [{ type:'debuff_target', stat:'spd', mult:0.85 }] } },
  },
  356: {
    35: { id:'corps_sans_vie_356', name:'Corps Sans Vie', desc:'+25% DEF et DEF spé',
      hooks:{ ON_SETUP: [{ type:'stat_boost', stat:'def', mult:1.25 }] } },
    70: { id:'antre_obscur_356', name:'Antre Obscur', desc:'Déclenche la Nuit Noire au début du combat',
      hooks:{ ON_SETUP: [{ type:'weather_setter', weather:'darkness' }] } },
  },
  357: {
    35: { id:'recolte_357', name:'Récolte', desc:'Soigne 5% PV à tous les alliés / 8 actions',
      hooks:{ ON_PERIODIC: [{ type:'heal_all', rate:0.05 }] } },
    70: { id:'chlorophylle_357', name:'Chlorophylle', desc:'+25% stats sous Zénith',
      hooks:{ ON_SETUP: [{ type:'weather_boost', mult:1.25 }] } },
  },
  358: {
    35: { id:'levitation_358', name:'Lévitation', desc:'Immunisé au type Sol',
      hooks:{ ON_SETUP: [{ type:'type_immunity', damageType:'Sol' }] } },
    70: { id:'echo_guerisseur_358', name:'Écho Guérisseur', desc:'Soigne 6% PV à tous les alliés / 8 actions',
      hooks:{ ON_PERIODIC: [{ type:'heal_all', rate:0.06 }] } },
  },
  359: {
    35: { id:'pression_359', name:'Pression', desc:'-20% ATK aux ennemis',
      hooks:{ ON_SETUP: [{ type:'intimidate', stats:['atk'], mult:0.8 }] } },
    70: { id:'coup_critique_359', name:'Coup Critique', desc:'30% de frapper une seconde fois',
      hooks:{ ON_ATTACK: [{ type:'bonus_hit', mult:0.6, chance:0.3 }] } },
  },
  360: {
    35: { id:'echec_360', name:'Échec', desc:'Riposte 30% des dégâts reçus',
      hooks:{ ON_RECEIVE: [{ type:'counter', rate:0.3 }] } },
    70: { id:'patience_360', name:'Patience', desc:'+8% ATK à chaque coup reçu (max 40%)',
      hooks:{ ON_RECEIVE: [{ type:'rage', stat:'atk', rate:0.08, max:0.4 }] } },
  },
  361: {
    35: { id:'corps_gel_361', name:'Corps Gel', desc:'20% de gel sur l\'attaquant',
      hooks:{ ON_RECEIVE: [{ type:'proc_status_attacker', status:'freeze', chance:0.2 }] } },
    70: { id:'givre_361', name:'Givre', desc:'+15% DEF',
      hooks:{ ON_SETUP: [{ type:'stat_boost', stat:'def', mult:1.15 }] } },
  },
  362: {
    35: { id:'corps_gel_362', name:'Corps Gel', desc:'25% de gel sur l\'attaquant',
      hooks:{ ON_RECEIVE: [{ type:'proc_status_attacker', status:'freeze', chance:0.25 }] } },
    70: { id:'grele_362', name:'Grêle', desc:'Déclenche la Grêle au début du combat',
      hooks:{ ON_SETUP: [{ type:'weather_setter', weather:'hail' }] } },
  },
  363: {
    35: { id:'epaisse_graisse_363', name:'Épaisse Graisse', desc:'+15% PV',
      hooks:{ ON_SETUP: [{ type:'stat_boost', stat:'hp', mult:1.15 }] } },
    70: { id:'glissade_363', name:'Glissade', desc:'+12% VIT',
      hooks:{ ON_SETUP: [{ type:'stat_boost', stat:'spd', mult:1.12 }] } },
  },
  364: {
    35: { id:'graisse_364', name:'Graisse', desc:'+18% PV',
      hooks:{ ON_SETUP: [{ type:'stat_boost', stat:'hp', mult:1.18 }] } },
    70: { id:'banquise_364', name:'Banquise', desc:'+18% DEF spé',
      hooks:{ ON_SETUP: [{ type:'stat_boost', stat:'spd_def', mult:1.18 }] } },
  },
  365: {
    35: { id:'colosse_polaire_365', name:'Colosse Polaire', desc:'+25% PV',
      hooks:{ ON_SETUP: [{ type:'stat_boost', stat:'hp', mult:1.25 }] } },
    70: { id:'tempete_de_grele_365', name:'Tempête de Grêle', desc:'Déclenche la Grêle au début du combat',
      hooks:{ ON_SETUP: [{ type:'weather_setter', weather:'hail' }] } },
  },
  366: {
    35: { id:'coquille_366', name:'Coquille', desc:'+20% DEF',
      hooks:{ ON_SETUP: [{ type:'stat_boost', stat:'def', mult:1.2 }] } },
    70: { id:'perle_366', name:'Perle', desc:'+15% ATK spé',
      hooks:{ ON_SETUP: [{ type:'stat_boost', stat:'spa', mult:1.15 }] } },
  },
  367: {
    35: { id:'gueule_beante_367', name:'Gueule Béante', desc:'+30% ATK',
      hooks:{ ON_SETUP: [{ type:'stat_boost', stat:'atk', mult:1.3 }] } },
    70: { id:'abysses_367', name:'Abysses', desc:'+35% ATK sous 50% PV',
      hooks:{ ON_ACTION: [{ type:'conditional_stat', stats:['atk'], mult:1.35, condition:'hp_below', threshold:0.5 }] } },
  },
  368: {
    35: { id:'ecailles_roses_368', name:'Écailles Roses', desc:'+30% DEF spé',
      hooks:{ ON_SETUP: [{ type:'stat_boost', stat:'spd_def', mult:1.3 }] } },
    70: { id:'chant_des_abysses_368', name:'Chant des Abysses', desc:'Soigne 6% PV à tous les alliés / 8 actions',
      hooks:{ ON_PERIODIC: [{ type:'heal_all', rate:0.06 }] } },
  },
  369: {
    35: { id:'fossile_vivant_369', name:'Fossile Vivant', desc:'+25% DEF',
      hooks:{ ON_SETUP: [{ type:'stat_boost', stat:'def', mult:1.25 }] } },
    70: { id:'resistance_antique_369', name:'Résistance Antique', desc:'-15% dégâts subis par les alliés',
      hooks:{ ON_SETUP: [{ type:'aura_dmg_reduction', mult:0.85 }] } },
  },
  370: {
    35: { id:'cur_tendre_370', name:'Cœur Tendre', desc:'Soigne 6% PV à l\'allié le plus blessé / 8 actions',
      hooks:{ ON_PERIODIC: [{ type:'heal_weakest_ally', rate:0.06 }] } },
    70: { id:'chance_370', name:'Chance', desc:'+15% VIT',
      hooks:{ ON_SETUP: [{ type:'stat_boost', stat:'spd', mult:1.15 }] } },
  },
  371: {
    35: { id:'muscle_371', name:'Muscle', desc:'+15% ATK',
      hooks:{ ON_SETUP: [{ type:'stat_boost', stat:'atk', mult:1.15 }] } },
    70: { id:'rage_371', name:'Rage', desc:'+6% ATK à chaque coup reçu (max 30%)',
      hooks:{ ON_RECEIVE: [{ type:'rage', stat:'atk', rate:0.06, max:0.3 }] } },
  },
  372: {
    35: { id:'carapace_372', name:'Carapace', desc:'+20% DEF',
      hooks:{ ON_SETUP: [{ type:'stat_boost', stat:'def', mult:1.2 }] } },
    70: { id:'perseverance_372', name:'Persévérance', desc:'+20% ATK',
      hooks:{ ON_SETUP: [{ type:'stat_boost', stat:'atk', mult:1.2 }] } },
  },
  373: {
    35: { id:'intimidation_373', name:'Intimidation', desc:'-20% ATK aux ennemis',
      hooks:{ ON_SETUP: [{ type:'intimidate', stats:['atk'], mult:0.8 }] } },
    70: { id:'vol_supreme_373', name:'Vol Suprême', desc:'+32% ATK',
      hooks:{ ON_SETUP: [{ type:'stat_boost', stat:'atk', mult:1.32 }] } },
  },
  374: {
    35: { id:'levitation_374', name:'Lévitation', desc:'Immunisé au type Sol',
      hooks:{ ON_SETUP: [{ type:'type_immunity', damageType:'Sol' }] } },
    70: { id:'blindage_374', name:'Blindage', desc:'+18% DEF',
      hooks:{ ON_SETUP: [{ type:'stat_boost', stat:'def', mult:1.18 }] } },
  },
  375: {
    35: { id:'corps_sain_375', name:'Corps Sain', desc:'Immunisé au poison et à la paralysie',
      hooks:{ ON_SETUP: [{ type:'status_immunity', statuses:['poison','paralyze'] }] } },
    70: { id:'fusion_375', name:'Fusion', desc:'+22% DEF',
      hooks:{ ON_SETUP: [{ type:'stat_boost', stat:'def', mult:1.22 }] } },
  },
  376: {
    35: { id:'corps_sain_376', name:'Corps Sain', desc:'Immunisé aux statuts majeurs',
      hooks:{ ON_SETUP: [{ type:'status_immunity', statuses:['poison','paralyze','burn'] }] } },
    70: { id:'titan_d_acier_376', name:'Titan d\'Acier', desc:'Bouclier et -15% dégâts aux alliés',
      hooks:{ ON_SETUP: [{ type:'shield' }] } },
  },
  377: {
    35: { id:'corps_rocheux_377', name:'Corps Rocheux', desc:'+30% DEF',
      hooks:{ ON_SETUP: [{ type:'stat_boost', stat:'def', mult:1.3 }] } },
    70: { id:'titan_de_roche_377', name:'Titan de Roche', desc:'Bouclier au début du combat',
      hooks:{ ON_SETUP: [{ type:'shield' }] } },
  },
  378: {
    35: { id:'corps_glace_378', name:'Corps Glacé', desc:'+30% DEF spé',
      hooks:{ ON_SETUP: [{ type:'stat_boost', stat:'spd_def', mult:1.3 }] } },
    70: { id:'titan_de_glace_378', name:'Titan de Glace', desc:'Déclenche la Grêle au début du combat',
      hooks:{ ON_SETUP: [{ type:'weather_setter', weather:'hail' }] } },
  },
  379: {
    35: { id:'corps_d_acier_379', name:'Corps d\'Acier', desc:'+28% DEF et DEF spé',
      hooks:{ ON_SETUP: [{ type:'stat_boost', stat:'def', mult:1.28 }] } },
    70: { id:'titan_d_acier_379', name:'Titan d\'Acier', desc:'-20% dégâts subis par les alliés',
      hooks:{ ON_SETUP: [{ type:'aura_dmg_reduction', mult:0.8 }] } },
  },
  380: {
    35: { id:'levitation_380', name:'Lévitation', desc:'Immunisé au type Sol',
      hooks:{ ON_SETUP: [{ type:'type_immunity', damageType:'Sol' }] } },
    70: { id:'sur_eternelle_380', name:'Sœur Éternelle', desc:'+14% toutes stats aux alliés',
      hooks:{ ON_SETUP: [{ type:'aura_all_boost', mult:1.14 }] } },
  },
  381: {
    35: { id:'levitation_381', name:'Lévitation', desc:'Immunisé au type Sol',
      hooks:{ ON_SETUP: [{ type:'type_immunity', damageType:'Sol' }] } },
    70: { id:'esprit_supreme_381', name:'Esprit Suprême', desc:'+35% ATK spé',
      hooks:{ ON_SETUP: [{ type:'stat_boost', stat:'spa', mult:1.35 }] } },
  },
  382: {
    35: { id:'maitre_des_mers_382', name:'Maître des Mers', desc:'Déclenche la Pluie au début du combat',
      hooks:{ ON_SETUP: [{ type:'weather_setter', weather:'rain' }] } },
    70: { id:'deluge_primordial_382', name:'Déluge Primordial', desc:'+30% stats sous Pluie',
      hooks:{ ON_SETUP: [{ type:'weather_boost', mult:1.3 }] } },
  },
  383: {
    35: { id:'maitre_des_terres_383', name:'Maître des Terres', desc:'Déclenche le Zénith au début du combat',
      hooks:{ ON_SETUP: [{ type:'weather_setter', weather:'sun' }] } },
    70: { id:'terre_primordiale_383', name:'Terre Primordiale', desc:'+30% stats sous Zénith',
      hooks:{ ON_SETUP: [{ type:'weather_boost', mult:1.3 }] } },
  },
  384: {
    35: { id:'air_lock_384', name:'Air Lock', desc:'Immunisé au type Sol',
      hooks:{ ON_SETUP: [{ type:'type_immunity', damageType:'Sol' }] } },
    70: { id:'souverain_du_ciel_384', name:'Souverain du Ciel', desc:'+38% ATK',
      hooks:{ ON_SETUP: [{ type:'stat_boost', stat:'atk', mult:1.38 }] } },
  },
  385: {
    35: { id:'exaucement_385', name:'Exaucement', desc:'+14% toutes stats aux alliés',
      hooks:{ ON_SETUP: [{ type:'aura_all_boost', mult:1.14 }] } },
    70: { id:'etoile_filante_385', name:'Étoile Filante', desc:'Ranime une fois avec 40% PV',
      hooks:{ ON_SETUP: [{ type:'revive_mark', rate:0.4 }] } },
  },
  386: {
    35: { id:'forme_attaque_386', name:'Forme Attaque', desc:'+35% ATK',
      hooks:{ ON_SETUP: [{ type:'stat_boost', stat:'atk', mult:1.35 }] } },
    70: { id:'mutation_386', name:'Mutation', desc:'+25% de la meilleure stat',
      hooks:{ ON_SETUP: [{ type:'boost_highest_stat', mult:1.25 }] } },
  },
};
