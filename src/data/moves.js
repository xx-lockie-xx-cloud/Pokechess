...
export const MOVES = {
  ...
  surf_heal:            { name:"Surf",             type:"Eau",      cat:"special",  bp:90,  target:"all_enemies",
    effects:[{kind:"heal",who:"allies_water",rate:0.5}] },
  ...
  explosion_forte:      { name:"Explosion",        type:"Normal",   cat:"special",  bp:280, target:"all_enemies", powerMult:1.0, priority:2,
    effects:[{kind:"sacrifice"}] },
  guillotine:           { name:"Guillotine",       type:"Normal",   cat:"physical", bp:1,   target:"single",
    effects:[{kind:"ko",chance:0.15}] },
