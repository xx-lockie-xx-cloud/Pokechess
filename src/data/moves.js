...
export const MOVES = {
  ...
  ultralaser:           { name:"Ultralaser",       type:"Normal",   cat:"special",  bp:150, target:"single",  powerMult:3.0,
    effects:[{kind:"skip_next"}] },
  explosion:            { name:"Explosion",        type:"Normal",   cat:"physical", bp:180, target:"all_enemies", powerMult:1.0,
    effects:[{kind:"sacrifice"}] },
  explosion_forte:      { name:"Explosion",        type:"Normal",   cat:"physical", bp:250, target:"all_enemies", powerMult:1.0, priority:2,
    effects:[{kind:"sacrifice"}] },
