...
export const ARENAS = [
  {
    ...
    champion:     'Pierre',
    type:         'Roche',
    badgeName:    'Badge Pierre',
    badgeEmoji:   '🪨',
    // Sprite HGSS de Pierre (Brock)
    championSprite: 'https://www.pokencyclopedia.info/sprites/trainers/hgss/hgss_gym1_brock.png',
  ...
  },
  {
    ...
    badgeEmoji:   '💧',
    championSprite: 'https://www.pokencyclopedia.info/sprites/trainers/hgss/hgss_gym2_misty.png',
    team: [
  ...
  },
  {
    ...
    badgeEmoji:   '⚡',
    championSprite: 'https://www.pokencyclopedia.info/sprites/trainers/hgss/hgss_gym3_surge.png',
    team: [
  ...
  },
  {
    ...
    badgeEmoji:   '🌿',
    championSprite: 'https://www.pokencyclopedia.info/sprites/trainers/hgss/hgss_gym4_erika.png',
    team: [
  ...
  },
  {
    ...
    badgeName:    'Badge Âme',
    badgeEmoji:   '☠️',
    championSprite: 'https://www.pokencyclopedia.info/sprites/trainers/hgss/hgss_gym5_koga.png',
    team: [
  ...
  },
  {
    ...
    badgeEmoji:   '🔥',
    championSprite: 'https://www.pokencyclopedia.info/sprites/trainers/hgss/hgss_gym6_blaine.png',
    team: [
  ...
  },
  {
    ...
    badgeEmoji:   '🔮',
    championSprite: 'https://www.pokencyclopedia.info/sprites/trainers/hgss/hgss_gym7_sabrina.png',
    team: [
  ...
  },
  {
    ...
    badgeEmoji:   '🏔',
    championSprite: 'https://www.pokencyclopedia.info/sprites/trainers/hgss/hgss_gym8_giovanni.png',
    team: [
  ...
  },
  {
    id:           9,
    city:         'Indigo',
    champion:     'Ligue Pokémon',
    type:         'Mixte',
    badgeName:    'Champion Pokémon',
    badgeEmoji:   '🏆',
    championSprite: null,  // scène spéciale Victory Road
